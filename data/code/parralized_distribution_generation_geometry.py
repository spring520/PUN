...
if __name__ == "__main__":
    ...
    script_path = os.path.join(root_path,'data/code/single_rotation_distribution_with_geometry.py')  # 子任务 Python 脚本路径
    ...
    models_to_process = ['02691156/1a04e3eab45ca15dd86060f189eb133']
